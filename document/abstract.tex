...
\vspace{6mm}
\begin{tabular}{l c}
    \heiti\zihao{3}{\textbf{Title}}&\songti\zihao{4}\uline{\makebox[27em][c]{The first line of your thesis title}}\\  % 您的论文标题第一行
    &\songti\zihao{4}\uline{\makebox[27em][c]{The second line of your thesis title}}  % 您的论文标题第二行
\end{tabular}
\vspace{4mm}
\newline
% 外文摘要
